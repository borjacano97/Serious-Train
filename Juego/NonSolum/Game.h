...
public:
	...
	enum Texturas_t {
	    ...
	    THistEsp1, THistEsp2, THistEsp3, THistEsp4, THistEsp5, THistEng1, THistEng2, THistEng3, THistEng4, THistEng5, TTramoFinal, TTramoRoca, THistoria6};
	...
	enum Hud_t { Tick, Hud1, Trayecto, Tren, Fondo, BotonOsc, Logo, Sangre, LetrasHist};
